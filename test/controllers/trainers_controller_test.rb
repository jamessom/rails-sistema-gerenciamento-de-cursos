...
class TrainersControllerTest < ActionController::TestCase
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post :create, trainer: { certificates: @trainer.certificates, email: @trainer.email, hour_value: @trainer.hour_value, name: @trainer.name }
    end
  ...
  test "should update trainer" do
    patch :update, id: @trainer, trainer: { certificates: @trainer.certificates, email: @trainer.email, hour_value: @trainer.hour_value, name: @trainer.name }
    assert_redirected_to trainer_path(assigns(:trainer))
  end
